...
public class SwerveCommandField extends Command
{
   ...
   */
  public SwerveCommandField(SwerveSubsystem swerve, DoubleSupplier vX, DoubleSupplier vY, DoubleSupplier headingHorizontal,
  ...
  {
    //makes sure to set robot position to current to prevent 7413 moment after auto ends
    initRotation = true;
  }
  ...
  public void execute()
  {
    ...
    SmartDashboard.putNumber("Rotational", desiredSpeeds.omegaRadiansPerSecond);
